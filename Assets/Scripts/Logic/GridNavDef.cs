...
namespace GridNav
{
    ...
    public enum NavSpeedModMultType { Idle = 0, Busy = 1, Moving = 2 };
    ...
    public class NavMoveParam
    {
        ...
        public float[] speedModMults = new float[NavDef.MaxSpeedModMultTypes]; // 对应NavSpeedModMultType 值越小，寻路消耗越大
